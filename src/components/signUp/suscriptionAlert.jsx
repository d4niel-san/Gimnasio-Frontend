...
function suscriptionAlert(id){
    ...
    switch(id){
        case 1: case 2: case 3:
            return(
                    <Alert variant="filled" severity="warning" sx={suscriptionTextSize}>
                    Switch to longer suscriptions for benefits and discounts!
                    </Alert>
                )
        case 4: 
            return(
                    <Alert variant="filled" severity="info" sx={suscriptionTextSize} >
                    Switching to longer suscriptions will cost you less.
                    </Alert>
                )
        case 5:
            return(
                    <Alert variant="filled" severity="success" sx={suscriptionTextSize}>
